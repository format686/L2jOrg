...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "org.l2j.gameserver/org.l2j.gameserver.GameServer"
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GAMESERVER_OPTS%  -classpath "%CLASSPATH%" org.l2j.gameserver.GameServer %CMD_LINE_ARGS%
